...
export default {
  ...
  assets: {
    ...
    twitter: {
      svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="-18128.258 10794.689 20.457 16.62"><defs><clipPath id="a"><path d="M344.056 21.673a2.173 2.173 0 01-2.046 0c.852-.511.895-.895 1.193-1.875a9.455 9.455 0 01-2.642 1.023 4.131 4.131 0 00-7.16 2.855 3.323 3.323 0 00.128.938 11.6 11.6 0 01-8.523-4.39 4.4 4.4 0 00-.554 2.131 4.241 4.241 0 001.833 3.495 4.542 4.542 0 01-1.875-.511v.043a4.252 4.252 0 003.324 4.134 3.971 3.971 0 01-1.875.085 4.079 4.079 0 003.878 2.9 8.285 8.285 0 01-6.137 1.747 11.573 11.573 0 006.35 1.875c7.628 0 11.762-6.393 11.762-11.933v-.554a9.563 9.563 0 002.344-1.96" transform="translate(-323.6 -19.5)"/></clipPath><clipPath id="b"><path d="M0 0h20.456v17.899H0z"/></clipPath></defs><g clip-path="url(#a)" transform="translate(-18128.259 10794.69)"><g transform="translate(0 -1.279)" clip-path="url(#b)"><path class="cls-3" d="M-6.393-5.114h33.241v29.406H-6.393z"/></g></g></svg>`,
